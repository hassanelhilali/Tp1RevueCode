...
// Liste pour stocker les centres de clusters
  private final List<double[]> clusterCenters = new ArrayList<>();
  // Obtenir l'instance avec un fichier en entrée
  ...
  public static AwesomePasswordChecker getInstance(File file) throws IOException {
    ...
    // Obtenir l'instance avec la ressource par défaut
  ...
  public static AwesomePasswordChecker getInstance() throws IOException {
    if (instance == null) {
      ...
      return instance;
        ...
        // Constructeur pour lire les centres de clusters depuis un flux d'entrée
  ...
  String line;
    ...
    br.close();
     ...
     // Générer un tableau de masques pour le mot de passe
  ...
  public int[] maskAff(String password) {
   ...
   /**
    * Calcule la distance minimale entre le mot de passe évalué et les lignes de clusterCenters[].
    * @param password le mot de passe à évaluer
    * @return la distance minimale entre le mot de passe évalué
    *         et chaque ligne de clusterCenters[]
    */
  public double getDistance(String password) {
   ...
   /**
    * Calcule la distance entre un mot de passe évalué avec maskAff() et un clusterCenter[].
    * @param a le mot de passe évalué
    * @param b une ligne de clusterCenter[]
  ...
  // Calculer le hash MD5 d'une chaîne
